...
class VISImageType<int>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(INT_MIN);}
    float rangeMax() const {return static_cast<float>(INT_MAX);}
};
...
class VISImageType<unsigned>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(0);}
    float rangeMax() const {return static_cast<float>(UINT_MAX);}
};
...
class VISImageType<short>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(SHRT_MIN);}
    float rangeMax() const {return static_cast<float>(SHRT_MAX);}
};
...
class VISImageType<unsigned short>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(0);}
    float rangeMax() const {return static_cast<float>(USHRT_MAX);}
};
...
class VISImageType<float>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(FLOAT_MIN);}
    float rangeMax() const {return static_cast<float>(FLOAT_MAX);}
};
...
class VISImageType<rgba>
{
  public:
    ...
    float rangeMin() const {return static_cast<float>(COLOR_MIN);}
    float rangeMax() const {return static_cast<float>(COLOR_MAX);}
};
