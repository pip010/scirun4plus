...
#ifndef iris_ply_image_file_h
#define iris_ply_image_file_h
...
class VISPlyImageFile
{
  ...
  public:
    ...
    VISImage<float> read(char* fname);
    // this one also give a confidence image
    VISImage<float> read(char* fname, VISImage<float> &confidence);
