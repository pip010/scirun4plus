...
public:
  ...
  virtual mtx_datatype w(const vec<4> &p, const vec<4> &tau)
  {std::cout << "Kernel::PROBLEM\n"; return 0.0;};
  virtual mtx_datatype w(const vec<4> &p, const vec<3> &tau)
  {std::cout << "Kernel::PROBLEM\n"; return 0.0;};
  virtual mtx_datatype w(const vec<4> &p, const vec<2> &tau)
  {std::cout << "Kernel::PROBLEM\n"; return 0.0;};
...
public:
  ...
  inline mtx_datatype w(const vec<4> &p, const vec<4> &tau)
...
public:
  ...
  inline mtx_datatype w(const vec<4> &p, const vec<3> &tau)
  { return DotProduct(p*M,tau); };
...
public:
  ...
  inline mtx_datatype w(const vec<4> &p, const vec<2> &tau)
  { return DotProduct(p*M,tau); };
