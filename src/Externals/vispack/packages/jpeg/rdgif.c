...
typedef struct {
  ...
  jpegBoolean out_of_blocks;	/* TRUE if hit terminator data block */
  ...
  jpegBoolean first_time;		/* flags first call to LZWReadByte */
  ...
  jpegBoolean is_interlaced;	/* TRUE if have interlaced image */
