...
/* Subroutine */ int chpevd_(char *jobz, char *uplo, integer *n, complex *ap, 
	real *w, complex *z, integer *ldz, complex *work, integer *lwork, 
...
/*     For eigenvalues only, call SSTERF.  For eigenvectors, first call   
	...
	cstedc_("I", n, &W(1), &RWORK(inde), &Z(1,1), ldz, &WORK(indwrk),
		 &llwrk, &RWORK(indrwk), &llrwk, &IWORK(1), liwork, info);
	cupmtr_("L", uplo, "N", n, n, &AP(1), &WORK(indtau), &Z(1,1), 
