...
/* Subroutine */ int zunmhr_(char *side, char *trans, integer *m, integer *n, 
	...
	doublecomplex *tau, doublecomplex *c, integer *ldc, doublecomplex *
...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *), zunmqr_(
...
/*     Quick return if possible */
    ...
    zunmqr_(side, trans, &mi, &ni, &nh, &A(*ilo+1,*ilo), lda, &
