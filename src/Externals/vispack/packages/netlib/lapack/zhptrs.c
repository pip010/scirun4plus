...
/*           1 x 1 diagonal block   
	    ...
	    kp = IPIV(k);
	    if (kp != k) {
		zswap_(nrhs, &B(k,1), ldb, &B(kp,1), ldb);
	    }
...
on   
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgeru_(&i__1, nrhs, &z__1, &AP(kc), &c__1, &B(k,1), ldb, &
		    B(1,1), ldb);
...
/*           2 x 2 diagonal block   
	    ...
	    kp = -IPIV(k);
	    if (kp != k - 1) {
		zswap_(nrhs, &B(k-1,1), ldb, &B(kp,1), ldb);
	    }
...
on   
	    ...
	    i__1 = k - 2;
	    z__1.r = -1., z__1.i = 0.;
	    zgeru_(&i__1, nrhs, &z__1, &AP(kc - (k - 1)), &c__1, &B(k-1,1), ldb, &B(1,1), ldb);

/*           Multiply by the inverse of the diagonal block. */

	    i__1 = kc + k - 2;
	    akm1k.r = AP(kc+k-2).r, akm1k.i = AP(kc+k-2).i;
	    ...
	    i__1 = *nrhs;
	    for (j = 1; j <= *nrhs; ++j) {
		z_div(&z__1, &B(k-1,j), &akm1k);
		bkm1.r = z__1.r, bkm1.i = z__1.i;
		d_cnjg(&z__2, &akm1k);
		z_div(&z__1, &B(k,j), &z__2);
...
ion   
	    ...
	    if (k > 1) {
		zlacgv_(nrhs, &B(k,1), ldb);
		i__1 = k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(1,1)
			, ldb, &AP(kc), &c__1, &c_b1, &B(k,1), ldb);
		zlacgv_(nrhs, &B(k,1), ldb);
	    }
...
rmation   
		...
		zlacgv_(nrhs, &B(k+1,1), ldb);
		i__1 = k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(1,1)
			, ldb, &AP(kc + k), &c__1, &c_b1, &B(k+1,1), 
			ldb);
		zlacgv_(nrhs, &B(k+1,1), ldb);
	    }
...
on   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &AP(kc + 1), &c__1, &B(k,1),
			 ldb, &B(k+1,1), ldb);
	    }
...
on   
		...
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &AP(kc + 2), &c__1, &B(k,1),
			 ldb, &B(k+2,1), ldb);
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &AP(kc + *n - k + 2), &c__1, &B(k+1,1), ldb, &B(k+2,1), ldb);
	    }

/*           Multiply by the inverse of the diagonal block. */

	    i__1 = kc + 1;
	    akm1k.r = AP(kc+1).r, akm1k.i = AP(kc+1).i;
	    d_cnjg(&z__2, &akm1k);
...
ion   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(k+1,1), ldb, &AP(kc + 1), &c__1, &c_b1, &B(k,1), ldb);
		zlacgv_(nrhs, &B(k,1), ldb);
	    }
...
rmation   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(k+1,1), ldb, &AP(kc - (*n - k)), &c__1, &c_b1, &B(k-1,1), ldb);
		zlacgv_(nrhs, &B(k-1,1), ldb);
	    }
