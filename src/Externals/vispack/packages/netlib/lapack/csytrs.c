...
ion   
	    ...
	    i__1 = k - 1;
	    q__1.r = -1.f, q__1.i = 0.f;
	    cgemv_("Transpose", &i__1, nrhs, &q__1, &B(1,1), ldb, &A(1,k), &c__1, &c_b1, &B(k,1), ldb);
...
rmation   
	    ...
	    i__1 = k - 1;
	    q__1.r = -1.f, q__1.i = 0.f;
	    cgemv_("Transpose", &i__1, nrhs, &q__1, &B(1,1), ldb, &A(1,k+1), &c__1, &c_b1, &B(k+1,1), ldb);
