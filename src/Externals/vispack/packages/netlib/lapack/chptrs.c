...
on   
	    ...
	    cgeru_(&i__1, nrhs, &q__1, &AP(kc), &c__1, &B(k,1), ldb, &
		    B(1,1), ldb);
...
on   
	    ...
	    i__1 = k - 2;
	    q__1.r = -1.f, q__1.i = 0.f;
	    cgeru_(&i__1, nrhs, &q__1, &AP(kc - (k - 1)), &c__1, &B(k-1,1), ldb, &B(1,1), ldb);
...
on   
		...
		i__1 = *n - k;
		q__1.r = -1.f, q__1.i = 0.f;
		cgeru_(&i__1, nrhs, &q__1, &AP(kc + 1), &c__1, &B(k,1),
			 ldb, &B(k+1,1), ldb);
	    }
...
on   
		...
		i__1 = *n - k - 1;
		q__1.r = -1.f, q__1.i = 0.f;
		cgeru_(&i__1, nrhs, &q__1, &AP(kc + 2), &c__1, &B(k,1),
			 ldb, &B(k+2,1), ldb);
		i__1 = *n - k - 1;
		q__1.r = -1.f, q__1.i = 0.f;
		cgeru_(&i__1, nrhs, &q__1, &AP(kc + *n - k + 2), &c__1, &B(k+1,1), ldb, &B(k+2,1), ldb);
	    }
...
ion   
		...
		i__1 = *n - k;
		q__1.r = -1.f, q__1.i = 0.f;
		cgemv_("Conjugate transpose", &i__1, nrhs, &q__1, &B(k+1,1), ldb, &AP(kc + 1), &c__1, &c_b1, &B(k,1), ldb);
		clacgv_(nrhs, &B(k,1), ldb);
	    }
...
rmation   
		...
		i__1 = *n - k;
		q__1.r = -1.f, q__1.i = 0.f;
		cgemv_("Conjugate transpose", &i__1, nrhs, &q__1, &B(k+1,1), ldb, &AP(kc - (*n - k)), &c__1, &c_b1, &B(k-1,1), ldb);
		clacgv_(nrhs, &B(k-1,1), ldb);
	    }
