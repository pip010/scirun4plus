...
/*        Copy column K of A to column KW of W and update it */
	...
	ccopy_(&k, &A(1,k), &c__1, &W(1,kw), &c__1);
	if (k < *n) {
	    i__1 = *n - k;
...
/*        Determine rows and columns to be interchanged and whether   
	...
	i__1 = k + kw * w_dim1;
	absakk = (r__1 = W(k,kw).r, dabs(r__1)) + (r__2 = r_imag(&W(k,kw)), dabs(r__2));
...
/*        IMAX is the row-index of the largest off-diagonal element in
	...
	if (k > 1) {
	    ...
	    i__1 = imax + kw * w_dim1;
	    colmax = (r__1 = W(imax,kw).r, dabs(r__1)) + (r__2 = r_imag(&W(imax,kw)), dabs(r__2));
	} else {
	    colmax = 0.f;
	}
...
e it */
		...
		ccopy_(&imax, &A(1,imax), &c__1, &W(1,kw-1), &c__1);
		i__1 = k - imax;
...
e value */
		...
		rowmax = (r__1 = W(jmax,kw-1).r, dabs(r__1)) + (r__2 = r_imag(&W(jmax,kw-1)), dabs(r__2));
		if (imax > 1) {
		    i__1 = imax - 1;
		    jmax = icamax_(&i__1, &W(1,kw-1), &c__1);
/* Computing MAX */
		    i__1 = jmax + (kw - 1) * w_dim1;
		    r__3 = rowmax, r__4 = (r__1 = W(jmax,kw-1).r, dabs(r__1)) + (
			    r__2 = r_imag(&W(jmax,kw-1)), dabs(
			    r__2));
...
*/
		    ...
		    if ((r__1 = W(imax,kw-1).r, dabs(r__1)) + (r__2 = r_imag(&W(imax,kw-1)), dabs(r__2)) >= alpha *
			     rowmax) {
...
of A and W */
		...
		i__1 = *n - kk + 1;
		cswap_(&i__1, &A(kk,kk), lda, &A(kp,kk),
			 lda);
		i__1 = *n - kk + 1;
...
k-1 of A */
			...
			i__2 = j + k * a_dim1;
			i__3 = j + kw * w_dim1;
			q__3.r = d22.r * W(j,kw).r - d22.i * W(j,kw).i, 
				q__3.i = d22.r * W(j,kw).i + d22.i * W(j,kw)
				.r;
			i__4 = j + (kw - 1) * w_dim1;
			q__2.r = q__3.r - W(j,kw-1).r, q__2.i = q__3.i - W(j,kw-1)
				.i;
			q__1.r = d21.r * q__2.r - d21.i * q__2.i, q__1.i = 
				d21.r * q__2.i + d21.i * q__2.r;
...
/*        Copy column K of A to column K of W and update it */
	...
	i__1 = *n - k + 1;
	ccopy_(&i__1, &A(k,k), &c__1, &W(k,k), &c__1);
	i__1 = *n - k + 1;
	i__2 = k - 1;
	q__1.r = -1.f, q__1.i = 0.f;
...
/*        Determine rows and columns to be interchanged and whether   
	...
	i__1 = k + k * w_dim1;
	absakk = (r__1 = W(k,k).r, dabs(r__1)) + (r__2 = r_imag(&W(k,k)), dabs(r__2));
...
/*        IMAX is the row-index of the largest off-diagonal element in
	...
	if (k < *n) {
	    ...
	    i__1 = imax + k * w_dim1;
	    colmax = (r__1 = W(imax,k).r, dabs(r__1)) + (r__2 = r_imag(&W(imax,k)), dabs(r__2));
	} else {
	    colmax = 0.f;
	}
...
/*              Copy column IMAX to column K+1 of W and update
 it */
		...
		i__1 = *n - imax + 1;
		ccopy_(&i__1, &A(imax,imax), &c__1, &W(imax,k+1), &c__1);
		i__1 = *n - k + 1;
		i__2 = k - 1;
		q__1.r = -1.f, q__1.i = 0.f;
...
e value */
		...
		rowmax = (r__1 = W(jmax,k+1).r, dabs(r__1)) + (r__2 = r_imag(&W(jmax,k+1)), dabs(r__2));
		if (imax < *n) {
		    i__1 = *n - imax;
		    jmax = imax + icamax_(&i__1, &W(imax+1,k+1), &c__1);
/* Computing MAX */
		    i__1 = jmax + (k + 1) * w_dim1;
		    r__3 = rowmax, r__4 = (r__1 = W(jmax,k+1).r, dabs(r__1)) + (
			    r__2 = r_imag(&W(jmax,k+1)), dabs(
			    r__2));
		    rowmax = dmax(r__3,r__4);
		}
...
*/
		    ...
		    if ((r__1 = W(imax,k+1).r, dabs(r__1)) + (r__2 = r_imag(&W(imax,k+1)), dabs(r__2)) >= alpha * 
			    rowmax) {
...
/*              Copy non-updated column KK to column KP */
		...
		A(kp,k).r = A(kk,k).r, A(kp,k).i = A(kk,k).i;
		i__1 = kp - k - 1;
		ccopy_(&i__1, &A(k+1,kk), &c__1, &A(kp,k+1), lda);
		i__1 = *n - kp + 1;
		ccopy_(&i__1, &A(kp,kk), &c__1, &A(kp,kp), &c__1);

/*              Interchange rows KK and KP in first KK columns
 of A and W */

		cswap_(&kk, &A(kk,1), lda, &A(kp,1), lda);
...
k+1 of A */
			...
			i__2 = j + k * a_dim1;
			i__3 = j + k * w_dim1;
			q__3.r = d11.r * W(j,k).r - d11.i * W(j,k).i, 
				q__3.i = d11.r * W(j,k).i + d11.i * W(j,k)
				.r;
			i__4 = j + (k + 1) * w_dim1;
			q__2.r = q__3.r - W(j,k+1).r, q__2.i = q__3.i - W(j,k+1)
				.i;
			q__1.r = d21.r * q__2.r - d21.i * q__2.i, q__1.i = 
				d21.r * q__2.i + d21.i * q__2.r;
			A(j,k).r = q__1.r, A(j,k).i = q__1.i;
