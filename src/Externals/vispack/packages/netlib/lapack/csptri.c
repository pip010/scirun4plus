...
/*           Compute column K of the inverse. */
		...
		q__1.r = AP(kc+k-1).r - q__2.r, q__1.i = AP(kc+k-1).i - q__2.i;
		AP(kc+k-1).r = q__1.r, AP(kc+k-1).i = q__1.i;
	    }
	    kstep = 1;
	} else {
...
/*           Compute columns K and K+1 of the inverse. */
		...
		q__1.r = AP(kcnext+k).r - q__2.r, q__1.i = AP(kcnext+k).i - q__2.i;
		AP(kcnext+k).r = q__1.r, AP(kcnext+k).i = q__1.i;
	    }
	    kstep = 2;
	    kcnext = kcnext + k + 1;
...
/*           Compute column K of the inverse. */
		...
		q__1.r = AP(kc).r - q__2.r, q__1.i = AP(kc).i - q__2.i;
		AP(kc).r = q__1.r, AP(kc).i = q__1.i;
	    }
	    kstep = 1;
	} else {
...
/*           Compute columns K-1 and K of the inverse. */
		...
		q__1.r = AP(kcnext).r - q__2.r, q__1.i = AP(kcnext).i - q__2.i;
		AP(kcnext).r = q__1.r, AP(kcnext).i = q__1.i;
	    }
	    kstep = 2;
	    kcnext -= *n - k + 3;
