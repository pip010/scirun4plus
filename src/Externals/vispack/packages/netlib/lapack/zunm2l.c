...
/*        Apply H(i) or H(i)' */
	...
	i__3 = nq - *k + i + i * a_dim1;
	aii.r = A(nq-*k+i,i).r, aii.i = A(nq-*k+i,i).i;
	i__3 = nq - *k + i + i * a_dim1;
	A(nq-*k+i,i).r = 1., A(nq-*k+i,i).i = 0.;
	zlarf_(side, &mi, &ni, &A(1,i), &c__1, &taui, &C(1,1),
		 ldc, &WORK(1));
	i__3 = nq - *k + i + i * a_dim1;
	A(nq-*k+i,i).r = aii.r, A(nq-*k+i,i).i = aii.i;
/* L10: */
    }
    return 0;
