...
/* Subroutine */ int cgeequ_(integer *m, integer *n, complex *a, integer *lda,
	 real *r, real *c, real *rowcnd, real *colcnd, real *amax, integer *
	info)
{
...
/* Computing MAX */
	    i__3 = i + j * a_dim1;
	    r__3 = R(i), r__4 = (r__1 = A(i,j).r, dabs(r__1)) + (r__2 = 
		    r_imag(&A(i,j)), dabs(r__2));
	    R(i) = dmax(r__3,r__4);
/* L20: */
	}
/* L30: */
...
/* Computing MAX */
	    i__3 = i + j * a_dim1;
	    r__3 = C(j), r__4 = ((r__1 = A(i,j).r, dabs(r__1)) + (r__2 = 
		    r_imag(&A(i,j)), dabs(r__2))) * R(i);
	    C(j) = dmax(r__3,r__4);
/* L80: */
	}
/* L90: */
