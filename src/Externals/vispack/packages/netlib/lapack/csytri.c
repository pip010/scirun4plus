...
/*           Compute column K of the inverse. */
		...
		csymv_(uplo, &i__1, &q__1, &A(1,1), lda, &WORK(1), &c__1,
			 &c_b2, &A(1,k), &c__1);
		i__1 = k + k * a_dim1;
		i__2 = k + k * a_dim1;
		i__3 = k - 1;
		cdotu_(&q__2, &i__3, &WORK(1), &c__1, &A(1,k), &
			c__1);
...
/*           2 x 2 diagonal block   
	    ...
	    c_div(&q__1, &A(k+1,k+1), &t);
	    akp1.r = q__1.r, akp1.i = q__1.i;
	    c_div(&q__1, &A(k,k+1), &t);
...
/*           Compute columns K and K+1 of the inverse. */
		...
		i__2 = k + (k + 1) * a_dim1;
		i__3 = k - 1;
		cdotu_(&q__2, &i__3, &A(1,k), &c__1, &A(1,k+1), &c__1);
		...
		i__2 = k + 1 + (k + 1) * a_dim1;
		i__3 = k - 1;
		cdotu_(&q__2, &i__3, &WORK(1), &c__1, &A(1,k+1)
			, &c__1);
		q__1.r = A(k+1,k+1).r - q__2.r, q__1.i = A(k+1,k+1).i - q__2.i;
		A(k+1,k+1).r = q__1.r, A(k+1,k+1).i = q__1.i;
	    }
	    kstep = 2;
	}
...
/*           Interchange rows and columns K and KP in the leading 
	    ...
	    cswap_(&i__1, &A(1,k), &c__1, &A(1,kp), &
		    c__1);
	    i__1 = k - kp - 1;
	    cswap_(&i__1, &A(kp+1,k), &c__1, &A(kp,kp+1), lda);
	    i__1 = k + k * a_dim1;
...
/*           Compute column K of the inverse. */
		...
		i__1 = *n - k;
		q__1.r = -1.f, q__1.i = 0.f;
		csymv_(uplo, &i__1, &q__1, &A(k+1,k+1), lda, 
			&WORK(1), &c__1, &c_b2, &A(k+1,k), &c__1);
		i__1 = k + k * a_dim1;
		i__2 = k + k * a_dim1;
		i__3 = *n - k;
		cdotu_(&q__2, &i__3, &WORK(1), &c__1, &A(k+1,k), 
			&c__1);
		q__1.r = A(k,k).r - q__2.r, q__1.i = A(k,k).i - q__2.i;
		A(k,k).r = q__1.r, A(k,k).i = q__1.i;
	    }
...
/*           Compute columns K-1 and K of the inverse. */
		...
		i__2 = k + (k - 1) * a_dim1;
		i__3 = *n - k;
		cdotu_(&q__2, &i__3, &A(k+1,k), &c__1, &A(k+1,k-1), &c__1);
		q__1.r = A(k,k-1).r - q__2.r, q__1.i = A(k,k-1).i - q__2.i;
		A(k,k-1).r = q__1.r, A(k,k-1).i = q__1.i;
		i__1 = *n - k;
		...
		i__2 = k - 1 + (k - 1) * a_dim1;
		i__3 = *n - k;
		cdotu_(&q__2, &i__3, &WORK(1), &c__1, &A(k+1,k-1), &c__1);
		q__1.r = A(k-1,k-1).r - q__2.r, q__1.i = A(k-1,k-1).i - q__2.i;
		A(k-1,k-1).r = q__1.r, A(k-1,k-1).i = q__1.i;
	    }
	    kstep = 2;
...
/*           Interchange rows and columns K and KP in the trailing
	    ...
	    i__1 = kp - k - 1;
	    cswap_(&i__1, &A(k+1,k), &c__1, &A(kp,k+1), lda);
	    i__1 = k + k * a_dim1;
	    temp.r = A(k,k).r, temp.i = A(k,k).i;
	    i__1 = k + k * a_dim1;
	    i__2 = kp + kp * a_dim1;
