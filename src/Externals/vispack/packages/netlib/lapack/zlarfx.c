...
/*        Special code for 8 x 8 Householder */
	...
	for (j = 1; j <= *n; ++j) {
	    ...
	    i__7 = j * c_dim1 + 6;
	    z__13.r = v6.r * C(6,j).r - v6.i * C(6,j).i, z__13.i = v6.r * C(6,j).i + v6.i * C(6,j).r;
	    z__3.r = z__4.r + z__13.r, z__3.i = z__4.i + z__13.i;
	    i__8 = j * c_dim1 + 7;
	    z__14.r = v7.r * C(7,j).r - v7.i * C(7,j).i, z__14.i = v7.r * C(7,j).i + v7.i * C(7,j).r;
	    z__2.r = z__3.r + z__14.r, z__2.i = z__3.i + z__14.i;
	    i__9 = j * c_dim1 + 8;
	    z__15.r = v8.r * C(8,j).r - v8.i * C(8,j).i, z__15.i = v8.r * C(8,j).i + v8.i * C(8,j).r;
	    ...
	    z__2.r = sum.r * t8.r - sum.i * t8.i, z__2.i = sum.r * t8.i + 
		    sum.i * t8.r;
	    z__1.r = C(8,j).r - z__2.r, z__1.i = C(8,j).i - z__2.i;
	    C(8,j).r = z__1.r, C(8,j).i = z__1.i;
/* L160: */
	}
	goto L410;
L170:
...
/*        Special code for 9 x 9 Householder */
	...
	for (j = 1; j <= *n; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__9.r = v1.r * C(1,j).r - v1.i * C(1,j).i, z__9.i = v1.r * C(1,j).i + v1.i * C(1,j).r;
	    i__3 = j * c_dim1 + 2;
	    z__10.r = v2.r * C(2,j).r - v2.i * C(2,j).i, z__10.i = v2.r * C(2,j).i + v2.i * C(2,j).r;
	    z__8.r = z__9.r + z__10.r, z__8.i = z__9.i + z__10.i;
	    i__4 = j * c_dim1 + 3;
	    z__11.r = v3.r * C(3,j).r - v3.i * C(3,j).i, z__11.i = v3.r * C(3,j).i + v3.i * C(3,j).r;
	    z__7.r = z__8.r + z__11.r, z__7.i = z__8.i + z__11.i;
	    i__5 = j * c_dim1 + 4;
	    z__12.r = v4.r * C(4,j).r - v4.i * C(4,j).i, z__12.i = v4.r * C(4,j).i + v4.i * C(4,j).r;
	    z__6.r = z__7.r + z__12.r, z__6.i = z__7.i + z__12.i;
	    i__6 = j * c_dim1 + 5;
	    z__13.r = v5.r * C(5,j).r - v5.i * C(5,j).i, z__13.i = v5.r * C(5,j).i + v5.i * C(5,j).r;
	    z__5.r = z__6.r + z__13.r, z__5.i = z__6.i + z__13.i;
	    i__7 = j * c_dim1 + 6;
	    z__14.r = v6.r * C(6,j).r - v6.i * C(6,j).i, z__14.i = v6.r * C(6,j).i + v6.i * C(6,j).r;
	    z__4.r = z__5.r + z__14.r, z__4.i = z__5.i + z__14.i;
	    i__8 = j * c_dim1 + 7;
	    z__15.r = v7.r * C(7,j).r - v7.i * C(7,j).i, z__15.i = v7.r * C(7,j).i + v7.i * C(7,j).r;
	    z__3.r = z__4.r + z__15.r, z__3.i = z__4.i + z__15.i;
	    i__9 = j * c_dim1 + 8;
	    z__16.r = v8.r * C(8,j).r - v8.i * C(8,j).i, z__16.i = v8.r * C(8,j).i + v8.i * C(8,j).r;
	    z__2.r = z__3.r + z__16.r, z__2.i = z__3.i + z__16.i;
	    i__10 = j * c_dim1 + 9;
	    z__17.r = v9.r * C(9,j).r - v9.i * C(9,j).i, z__17.i = v9.r * 
	    ...
	    z__2.r = sum.r * t9.r - sum.i * t9.i, z__2.i = sum.r * t9.i + 
		    sum.i * t9.r;
	    z__1.r = C(9,j).r - z__2.r, z__1.i = C(9,j).i - z__2.i;
	    C(9,j).r = z__1.r, C(9,j).i = z__1.i;
/* L180: */
	}
	goto L410;
L190:
...
/*        Special code for 10 x 10 Householder */
	...
	for (j = 1; j <= *n; ++j) {
	    i__2 = j * c_dim1 + 1;
	    z__10.r = v1.r * C(1,j).r - v1.i * C(1,j).i, z__10.i = v1.r * C(1,j).i + v1.i * C(1,j).r;
	    i__3 = j * c_dim1 + 2;
	    z__11.r = v2.r * C(2,j).r - v2.i * C(2,j).i, z__11.i = v2.r * C(2,j).i + v2.i * C(2,j).r;
	    z__9.r = z__10.r + z__11.r, z__9.i = z__10.i + z__11.i;
	    i__4 = j * c_dim1 + 3;
	    z__12.r = v3.r * C(3,j).r - v3.i * C(3,j).i, z__12.i = v3.r * C(3,j).i + v3.i * C(3,j).r;
	    z__8.r = z__9.r + z__12.r, z__8.i = z__9.i + z__12.i;
	    i__5 = j * c_dim1 + 4;
	    z__13.r = v4.r * C(4,j).r - v4.i * C(4,j).i, z__13.i = v4.r * C(4,j).i + v4.i * C(4,j).r;
	    z__7.r = z__8.r + z__13.r, z__7.i = z__8.i + z__13.i;
	    i__6 = j * c_dim1 + 5;
	    z__14.r = v5.r * C(5,j).r - v5.i * C(5,j).i, z__14.i = v5.r * C(5,j).i + v5.i * C(5,j).r;
	    z__6.r = z__7.r + z__14.r, z__6.i = z__7.i + z__14.i;
	    i__7 = j * c_dim1 + 6;
	    z__15.r = v6.r * C(6,j).r - v6.i * C(6,j).i, z__15.i = v6.r * C(6,j).i + v6.i * C(6,j).r;
	    z__5.r = z__6.r + z__15.r, z__5.i = z__6.i + z__15.i;
	    i__8 = j * c_dim1 + 7;
	    z__16.r = v7.r * C(7,j).r - v7.i * C(7,j).i, z__16.i = v7.r * C(7,j).i + v7.i * C(7,j).r;
	    z__4.r = z__5.r + z__16.r, z__4.i = z__5.i + z__16.i;
	    i__9 = j * c_dim1 + 8;
	    z__17.r = v8.r * C(8,j).r - v8.i * C(8,j).i, z__17.i = v8.r * C(8,j).i + v8.i * C(8,j).r;
	    z__3.r = z__4.r + z__17.r, z__3.i = z__4.i + z__17.i;
	    i__10 = j * c_dim1 + 9;
	    z__18.r = v9.r * C(9,j).r - v9.i * C(9,j).i, z__18.i = v9.r * 
		    C(9,j).i + v9.i * C(9,j).r;
	    z__2.r = z__3.r + z__18.r, z__2.i = z__3.i + z__18.i;
	    i__11 = j * c_dim1 + 10;
	    z__19.r = v10.r * C(10,j).r - v10.i * C(10,j).i, z__19.i = 
	    ...
	    z__2.r = sum.r * t10.r - sum.i * t10.i, z__2.i = sum.r * t10.i + 
		    sum.i * t10.r;
	    z__1.r = C(10,j).r - z__2.r, z__1.i = C(10,j).i - z__2.i;
	    C(10,j).r = z__1.r, C(10,j).i = z__1.i;
/* L200: */
	}
	goto L410;
    } else {
...
/*        Code for general N   
	...
	zgemv_("No transpose", m, n, &c_b2, &C(1,1), ldc, &V(1), &c__1, &
		c_b1, &WORK(1), &c__1);

/*        C := C - tau * w * v' */

	z__1.r = -tau->r, z__1.i = -tau->i;
	zgerc_(m, n, &z__1, &WORK(1), &c__1, &V(1), &c__1, &C(1,1), ldc);
	goto L410;
L210:
...
/*        Special code for 1 x 1 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    z__1.r = t1.r * C(j,1).r - t1.i * C(j,1).i, z__1.i = t1.r * C(j,1).i + t1.i * C(j,1).r;
	    C(j,1).r = z__1.r, C(j,1).i = z__1.i;
/* L220: */
	}
	goto L410;
L230:
...
/*        Special code for 2 x 2 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__2.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__2.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__3.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__3.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__1.r = z__2.r + z__3.r, z__1.i = z__2.i + z__3.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    z__2.r = sum.r * t1.r - sum.i * t1.i, z__2.i = sum.r * t1.i + 
		    sum.i * t1.r;
	    z__1.r = C(j,1).r - z__2.r, z__1.i = C(j,1).i - z__2.i;
	    C(j,1).r = z__1.r, C(j,1).i = z__1.i;
	    i__2 = j + (c_dim1 << 1);
	    i__3 = j + (c_dim1 << 1);
	    z__2.r = sum.r * t2.r - sum.i * t2.i, z__2.i = sum.r * t2.i + 
		    sum.i * t2.r;
	    z__1.r = C(j,2).r - z__2.r, z__1.i = C(j,2).i - z__2.i;
	    C(j,2).r = z__1.r, C(j,2).i = z__1.i;
/* L240: */
	}
	goto L410;
L250:
...
/*        Special code for 3 x 3 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__3.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__3.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__4.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__4.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__2.r = z__3.r + z__4.r, z__2.i = z__3.i + z__4.i;
	    i__4 = j + c_dim1 * 3;
	    z__5.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__5.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__1.r = z__2.r + z__5.r, z__1.i = z__2.i + z__5.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t3.r - sum.i * t3.i, z__2.i = sum.r * t3.i + 
		    sum.i * t3.r;
	    z__1.r = C(j,3).r - z__2.r, z__1.i = C(j,3).i - z__2.i;
	    C(j,3).r = z__1.r, C(j,3).i = z__1.i;
/* L260: */
	}
	goto L410;
L270:
...
/*        Special code for 4 x 4 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__4.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__4.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__5.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__5.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__3.r = z__4.r + z__5.r, z__3.i = z__4.i + z__5.i;
	    i__4 = j + c_dim1 * 3;
	    z__6.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__6.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__2.r = z__3.r + z__6.r, z__2.i = z__3.i + z__6.i;
	    i__5 = j + (c_dim1 << 2);
	    z__7.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__7.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__1.r = z__2.r + z__7.r, z__1.i = z__2.i + z__7.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t4.r - sum.i * t4.i, z__2.i = sum.r * t4.i + 
		    sum.i * t4.r;
	    z__1.r = C(j,4).r - z__2.r, z__1.i = C(j,4).i - z__2.i;
	    C(j,4).r = z__1.r, C(j,4).i = z__1.i;
/* L280: */
	}
	goto L410;
L290:
...
/*        Special code for 5 x 5 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__5.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__5.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__6.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__6.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__4.r = z__5.r + z__6.r, z__4.i = z__5.i + z__6.i;
	    i__4 = j + c_dim1 * 3;
	    z__7.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__7.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__3.r = z__4.r + z__7.r, z__3.i = z__4.i + z__7.i;
	    i__5 = j + (c_dim1 << 2);
	    z__8.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__8.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__2.r = z__3.r + z__8.r, z__2.i = z__3.i + z__8.i;
	    i__6 = j + c_dim1 * 5;
	    z__9.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__9.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__1.r = z__2.r + z__9.r, z__1.i = z__2.i + z__9.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t5.r - sum.i * t5.i, z__2.i = sum.r * t5.i + 
		    sum.i * t5.r;
	    z__1.r = C(j,5).r - z__2.r, z__1.i = C(j,5).i - z__2.i;
	    C(j,5).r = z__1.r, C(j,5).i = z__1.i;
/* L300: */
	}
	goto L410;
L310:
...
/*        Special code for 6 x 6 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__6.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__6.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__7.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__7.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__5.r = z__6.r + z__7.r, z__5.i = z__6.i + z__7.i;
	    i__4 = j + c_dim1 * 3;
	    z__8.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__8.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__4.r = z__5.r + z__8.r, z__4.i = z__5.i + z__8.i;
	    i__5 = j + (c_dim1 << 2);
	    z__9.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__9.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__3.r = z__4.r + z__9.r, z__3.i = z__4.i + z__9.i;
	    i__6 = j + c_dim1 * 5;
	    z__10.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__10.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__2.r = z__3.r + z__10.r, z__2.i = z__3.i + z__10.i;
	    i__7 = j + c_dim1 * 6;
	    z__11.r = v6.r * C(j,6).r - v6.i * C(j,6).i, z__11.i = v6.r * C(j,6).i + v6.i * C(j,6).r;
	    z__1.r = z__2.r + z__11.r, z__1.i = z__2.i + z__11.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t6.r - sum.i * t6.i, z__2.i = sum.r * t6.i + 
		    sum.i * t6.r;
	    z__1.r = C(j,6).r - z__2.r, z__1.i = C(j,6).i - z__2.i;
	    C(j,6).r = z__1.r, C(j,6).i = z__1.i;
/* L320: */
	}
	goto L410;
L330:
...
/*        Special code for 7 x 7 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__7.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__7.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__8.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__8.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__6.r = z__7.r + z__8.r, z__6.i = z__7.i + z__8.i;
	    i__4 = j + c_dim1 * 3;
	    z__9.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__9.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__5.r = z__6.r + z__9.r, z__5.i = z__6.i + z__9.i;
	    i__5 = j + (c_dim1 << 2);
	    z__10.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__10.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__4.r = z__5.r + z__10.r, z__4.i = z__5.i + z__10.i;
	    i__6 = j + c_dim1 * 5;
	    z__11.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__11.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__3.r = z__4.r + z__11.r, z__3.i = z__4.i + z__11.i;
	    i__7 = j + c_dim1 * 6;
	    z__12.r = v6.r * C(j,6).r - v6.i * C(j,6).i, z__12.i = v6.r * C(j,6).i + v6.i * C(j,6).r;
	    z__2.r = z__3.r + z__12.r, z__2.i = z__3.i + z__12.i;
	    i__8 = j + c_dim1 * 7;
	    z__13.r = v7.r * C(j,7).r - v7.i * C(j,7).i, z__13.i = v7.r * C(j,7).i + v7.i * C(j,7).r;
	    z__1.r = z__2.r + z__13.r, z__1.i = z__2.i + z__13.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t7.r - sum.i * t7.i, z__2.i = sum.r * t7.i + 
		    sum.i * t7.r;
	    z__1.r = C(j,7).r - z__2.r, z__1.i = C(j,7).i - z__2.i;
	    C(j,7).r = z__1.r, C(j,7).i = z__1.i;
/* L340: */
	}
	goto L410;
L350:
...
/*        Special code for 8 x 8 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__8.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__8.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__9.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__9.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__7.r = z__8.r + z__9.r, z__7.i = z__8.i + z__9.i;
	    i__4 = j + c_dim1 * 3;
	    z__10.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__10.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__6.r = z__7.r + z__10.r, z__6.i = z__7.i + z__10.i;
	    i__5 = j + (c_dim1 << 2);
	    z__11.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__11.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__5.r = z__6.r + z__11.r, z__5.i = z__6.i + z__11.i;
	    i__6 = j + c_dim1 * 5;
	    z__12.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__12.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__4.r = z__5.r + z__12.r, z__4.i = z__5.i + z__12.i;
	    i__7 = j + c_dim1 * 6;
	    z__13.r = v6.r * C(j,6).r - v6.i * C(j,6).i, z__13.i = v6.r * C(j,6).i + v6.i * C(j,6).r;
	    z__3.r = z__4.r + z__13.r, z__3.i = z__4.i + z__13.i;
	    i__8 = j + c_dim1 * 7;
	    z__14.r = v7.r * C(j,7).r - v7.i * C(j,7).i, z__14.i = v7.r * C(j,7).i + v7.i * C(j,7).r;
	    z__2.r = z__3.r + z__14.r, z__2.i = z__3.i + z__14.i;
	    i__9 = j + (c_dim1 << 3);
	    z__15.r = v8.r * C(j,8).r - v8.i * C(j,8).i, z__15.i = v8.r * C(j,8).i + v8.i * C(j,8).r;
	    z__1.r = z__2.r + z__15.r, z__1.i = z__2.i + z__15.i;
	    sum.r = z__1.r, sum.i = z__1.i;
	    i__2 = j + c_dim1;
	    i__3 = j + c_dim1;
	    ...
	    z__2.r = sum.r * t8.r - sum.i * t8.i, z__2.i = sum.r * t8.i + 
		    sum.i * t8.r;
	    z__1.r = C(j,8).r - z__2.r, z__1.i = C(j,8).i - z__2.i;
	    C(j,8).r = z__1.r, C(j,8).i = z__1.i;
/* L360: */
	}
	goto L410;
L370:
...
/*        Special code for 9 x 9 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__9.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__9.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__10.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__10.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__8.r = z__9.r + z__10.r, z__8.i = z__9.i + z__10.i;
	    i__4 = j + c_dim1 * 3;
	    z__11.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__11.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__7.r = z__8.r + z__11.r, z__7.i = z__8.i + z__11.i;
	    i__5 = j + (c_dim1 << 2);
	    z__12.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__12.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__6.r = z__7.r + z__12.r, z__6.i = z__7.i + z__12.i;
	    i__6 = j + c_dim1 * 5;
	    z__13.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__13.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__5.r = z__6.r + z__13.r, z__5.i = z__6.i + z__13.i;
	    i__7 = j + c_dim1 * 6;
	    z__14.r = v6.r * C(j,6).r - v6.i * C(j,6).i, z__14.i = v6.r * C(j,6).i + v6.i * C(j,6).r;
	    z__4.r = z__5.r + z__14.r, z__4.i = z__5.i + z__14.i;
	    i__8 = j + c_dim1 * 7;
	    z__15.r = v7.r * C(j,7).r - v7.i * C(j,7).i, z__15.i = v7.r * C(j,7).i + v7.i * C(j,7).r;
	    z__3.r = z__4.r + z__15.r, z__3.i = z__4.i + z__15.i;
	    i__9 = j + (c_dim1 << 3);
	    z__16.r = v8.r * C(j,8).r - v8.i * C(j,8).i, z__16.i = v8.r * C(j,8).i + v8.i * C(j,8).r;
	    z__2.r = z__3.r + z__16.r, z__2.i = z__3.i + z__16.i;
	    i__10 = j + c_dim1 * 9;
	    z__17.r = v9.r * C(j,9).r - v9.i * C(j,9).i, z__17.i = v9.r * 
	    ...
	    z__2.r = sum.r * t9.r - sum.i * t9.i, z__2.i = sum.r * t9.i + 
		    sum.i * t9.r;
	    z__1.r = C(j,9).r - z__2.r, z__1.i = C(j,9).i - z__2.i;
	    C(j,9).r = z__1.r, C(j,9).i = z__1.i;
/* L380: */
	}
	goto L410;
L390:
...
/*        Special code for 10 x 10 Householder */
	...
	for (j = 1; j <= *m; ++j) {
	    i__2 = j + c_dim1;
	    z__10.r = v1.r * C(j,1).r - v1.i * C(j,1).i, z__10.i = v1.r * C(j,1).i + v1.i * C(j,1).r;
	    i__3 = j + (c_dim1 << 1);
	    z__11.r = v2.r * C(j,2).r - v2.i * C(j,2).i, z__11.i = v2.r * C(j,2).i + v2.i * C(j,2).r;
	    z__9.r = z__10.r + z__11.r, z__9.i = z__10.i + z__11.i;
	    i__4 = j + c_dim1 * 3;
	    z__12.r = v3.r * C(j,3).r - v3.i * C(j,3).i, z__12.i = v3.r * C(j,3).i + v3.i * C(j,3).r;
	    z__8.r = z__9.r + z__12.r, z__8.i = z__9.i + z__12.i;
	    i__5 = j + (c_dim1 << 2);
	    z__13.r = v4.r * C(j,4).r - v4.i * C(j,4).i, z__13.i = v4.r * C(j,4).i + v4.i * C(j,4).r;
	    z__7.r = z__8.r + z__13.r, z__7.i = z__8.i + z__13.i;
	    i__6 = j + c_dim1 * 5;
	    z__14.r = v5.r * C(j,5).r - v5.i * C(j,5).i, z__14.i = v5.r * C(j,5).i + v5.i * C(j,5).r;
	    z__6.r = z__7.r + z__14.r, z__6.i = z__7.i + z__14.i;
	    i__7 = j + c_dim1 * 6;
	    z__15.r = v6.r * C(j,6).r - v6.i * C(j,6).i, z__15.i = v6.r * C(j,6).i + v6.i * C(j,6).r;
	    z__5.r = z__6.r + z__15.r, z__5.i = z__6.i + z__15.i;
	    i__8 = j + c_dim1 * 7;
	    z__16.r = v7.r * C(j,7).r - v7.i * C(j,7).i, z__16.i = v7.r * C(j,7).i + v7.i * C(j,7).r;
	    z__4.r = z__5.r + z__16.r, z__4.i = z__5.i + z__16.i;
	    i__9 = j + (c_dim1 << 3);
	    z__17.r = v8.r * C(j,8).r - v8.i * C(j,8).i, z__17.i = v8.r * C(j,8).i + v8.i * C(j,8).r;
	    z__3.r = z__4.r + z__17.r, z__3.i = z__4.i + z__17.i;
	    i__10 = j + c_dim1 * 9;
	    z__18.r = v9.r * C(j,9).r - v9.i * C(j,9).i, z__18.i = v9.r * 
		    C(j,9).i + v9.i * C(j,9).r;
	    z__2.r = z__3.r + z__18.r, z__2.i = z__3.i + z__18.i;
	    i__11 = j + c_dim1 * 10;
	    z__19.r = v10.r * C(j,10).r - v10.i * C(j,10).i, z__19.i = 
	    ...
	    z__2.r = sum.r * t10.r - sum.i * t10.i, z__2.i = sum.r * t10.i + 
		    sum.i * t10.r;
	    z__1.r = C(j,10).r - z__2.r, z__1.i = C(j,10).i - z__2.i;
	    C(j,10).r = z__1.r, C(j,10).i = z__1.i;
/* L400: */
	}
	goto L410;
    }
