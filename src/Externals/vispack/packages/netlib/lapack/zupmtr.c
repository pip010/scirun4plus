...
/* Subroutine */ int zupmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, doublecomplex *ap, doublecomplex *tau, doublecomplex *c, 
...
/*           Apply H(i) or H(i)' */
	    ...
	    i__3 = ii;
	    aii.r = AP(ii).r, aii.i = AP(ii).i;
	    i__3 = ii;
	    AP(ii).r = 1., AP(ii).i = 0.;
	    zlarf_(side, &mi, &ni, &AP(ii - i + 1), &c__1, &taui, &C(1,1)
		    , ldc, &WORK(1));
	    i__3 = ii;
	    AP(ii).r = aii.r, AP(ii).i = aii.i;
...
/*           Apply H(i) or H(i)' */
	    ...
	    zlarf_(side, &mi, &ni, &AP(ii), &c__1, &taui, &C(ic,jc)
		    , ldc, &WORK(1));
	    i__3 = ii;
	    AP(ii).r = aii.r, AP(ii).i = aii.i;
