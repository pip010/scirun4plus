...
/* Computing MAX */
		i__3 = *k + 1 + j * ab_dim1;
		r__2 = value, r__3 = (r__1 = AB(*k+1,j).r, dabs(r__1));
...
/* Computing MAX */
		i__3 = j * ab_dim1 + 1;
		r__2 = value, r__3 = (r__1 = AB(1,j).r, dabs(r__1));
		value = dmax(r__2,r__3);
/* Computing MIN */
		i__2 = *n + 1 - j, i__4 = *k + 1;
		i__3 = min(i__2,i__4);
...
/* L50: */
		...
		i__4 = *k + 1 + j * ab_dim1;
		WORK(j) = sum + (r__1 = AB(*k+1,j).r, dabs(r__1));
/* L60: */
	    }
	    i__1 = *n;
	    for (i = 1; i <= *n; ++i) {
...
/* L80: */
	    ...
	    for (j = 1; j <= *n; ++j) {
		i__4 = j * ab_dim1 + 1;
		sum = WORK(j) + (r__1 = AB(1,j).r, dabs(r__1));
		l = 1 - j;
/* Computing MIN */
		i__3 = *n, i__2 = j + *k;
		i__4 = min(i__3,i__2);
...
/* Computing MAX */
		    i__2 = *k + 2 - j;
		    classq_(&i__4, &AB(max(*k+2-j,1),j), &c__1, &
			    scale, &sum);
/* L110: */
		}
		l = *k + 1;
...
/* Computing MIN */
		    i__3 = *n - j;
		    i__4 = min(i__3,*k);
		    classq_(&i__4, &AB(2,j), &c__1, &scale, &sum);
/* L120: */
		}
		l = 1;
	    }
