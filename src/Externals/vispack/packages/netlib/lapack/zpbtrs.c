...
/*           Solve U'*X = B, overwriting B with X. */
	    ...
	    ztbsv_("Upper", "Conjugate transpose", "Non-unit", n, kd, &AB(1,1), ldab, &B(1,j), &c__1);

/*           Solve U*X = B, overwriting B with X. */

	    ztbsv_("Upper", "No transpose", "Non-unit", n, kd, &AB(1,1),
		     ldab, &B(1,j), &c__1);
/* L10: */
	}
    } else {
...
/*           Solve L*X = B, overwriting B with X. */
	    ...
	    ztbsv_("Lower", "No transpose", "Non-unit", n, kd, &AB(1,1),
		     ldab, &B(1,j), &c__1);

/*           Solve L'*X = B, overwriting B with X. */

	    ztbsv_("Lower", "Conjugate transpose", "Non-unit", n, kd, &AB(1,1), ldab, &B(1,j), &c__1);
/* L20: */
	}
    }
