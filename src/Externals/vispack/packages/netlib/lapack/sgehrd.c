...
/*     Determine the block size.   
   ...
   Computing MIN */
    i__1 = 64, i__2 = ilaenv_(&c__1, "SGEHRD", " ", n, ilo, ihi, &c_n1, 6L, 
	    1L);
    nb = min(i__1,i__2);
    nbmin = 2;
    iws = 1;
...
'   
 ...
 A*V*T */
	    ...
	    slahrd_(ihi, &i, &ib, &A(1,i), lda, &TAU(i), t, &c__65,
		     &WORK(1), &ldwork);
...
be set   
	    ...
	    A(i+ib,i+ib-1) = 1.f;
	    i__3 = *ihi - i - ib + 1;
	    sgemm_("No transpose", "Transpose", ihi, &i__3, &ib, &c_b21, &
...
/*     Use unblocked code to reduce the rest of the matrix */
    ...
    sgehd2_(n, &i, ihi, &A(1,1), lda, &TAU(1), &WORK(1), &iinfo);
    WORK(1) = (real) iws;
