...
/*     Determine the block size for this environment */
    ...
    nb = ilaenv_(&c__1, "SPBTRF", uplo, n, kd, &c_n1, &c_n1, 6L, 1L);
...
/*        Use unblocked code */
	...
	spbtf2_(uplo, n, kd, &AB(1,1), ldab, info);
    } else {
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		spotf2_(uplo, &ib, &AB(*kd+1,i), &i__3, &ii)
			;
		if (ii != 0) {
		    *info = i + ii - 1;
		    goto L150;
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			ssyrk_("Upper", "Transpose", &i2, &ib, &c_b21, &AB(*kd+1-ib,i+ib), &i__3, &
				c_b18, &AB(*kd+1,i+ib), &
				i__4);
		    }
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		spotf2_(uplo, &ib, &AB(1,i), &i__3, &ii);
		if (ii != 0) {
		    *info = i + ii - 1;
		    goto L150;
		}
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			ssyrk_("Lower", "No Transpose", &i2, &ib, &c_b21, &AB(ib+1,i), &i__3, &c_b18, &AB(1,i+ib), &i__4);
		    }
