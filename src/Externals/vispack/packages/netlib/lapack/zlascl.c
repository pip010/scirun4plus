...
/* Subroutine */ int zlascl_(char *type, integer *kl, integer *ku, doublereal 
	*cfrom, doublereal *cto, integer *m, integer *n, doublecomplex *a, 
...
/*        Full matrix */
	...
	for (j = 1; j <= *n; ++j) {
		...
		i__3 = i + j * a_dim1;
		i__4 = i + j * a_dim1;
		z__1.r = mul * A(i,j).r, z__1.i = mul * A(i,j).i;
