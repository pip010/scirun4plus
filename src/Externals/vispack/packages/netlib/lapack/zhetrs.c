...
ion   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(k+1,1), ldb, &A(k+1,k), &c__1, &c_b1, &
			B(k,1), ldb);
		zlacgv_(nrhs, &B(k,1), ldb);
	    }
...
rmation   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &B(k+1,1), ldb, &A(k+1,k-1), &c__1, &
			c_b1, &B(k-1,1), ldb);
		zlacgv_(nrhs, &B(k-1,1), ldb);
	    }
