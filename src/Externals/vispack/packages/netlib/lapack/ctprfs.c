...
/*           Compute abs(A)*abs(X) + abs(B). */
		...
		if (nounit) {
			...
			for (i = 1; i <= k; ++i) {
			    i__4 = kc + i - 1;
			    RWORK(i) += ((r__1 = AP(kc+i-1).r, dabs(r__1)) + (
				    r__2 = r_imag(&AP(kc + i - 1)), dabs(r__2)
				    )) * xk;
/* L30: */
			}
			kc += k;
...
/* L60: */
		...
		if (nounit) {
			...
			for (i = k; i <= *n; ++i) {
			    i__4 = kc + i - k;
			    RWORK(i) += ((r__1 = AP(kc+i-k).r, dabs(r__1)) + (
				    r__2 = r_imag(&AP(kc + i - k)), dabs(r__2)
				    )) * xk;
/* L70: */
			}
			kc = kc + *n - k + 1;
...
/*           Compute abs(A**H)*abs(X) + abs(B). */
		...
		if (nounit) {
			...
			for (i = 1; i <= k; ++i) {
			    i__4 = kc + i - 1;
			    i__5 = i + j * x_dim1;
			    s += ((r__1 = AP(kc+i-1).r, dabs(r__1)) + (r__2 = 
				    r_imag(&AP(kc + i - 1)), dabs(r__2))) * ((
...
/* L140: */
		...
		if (nounit) {
			...
			for (i = k; i <= *n; ++i) {
			    i__4 = kc + i - k;
			    i__5 = i + j * x_dim1;
			    s += ((r__1 = AP(kc+i-k).r, dabs(r__1)) + (r__2 = 
				    r_imag(&AP(kc + i - k)), dabs(r__2))) * ((
				    r__3 = X(i,j).r, dabs(r__3)) + (r__4 = 
				    r_imag(&X(i,j)), dabs(r__4)));
/* L150: */
			}
