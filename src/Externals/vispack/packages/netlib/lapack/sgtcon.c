...
/* Subroutine */ int sgtcon_(char *norm, integer *n, real *dl, real *d, real *
	du, real *du2, integer *ipiv, real *anorm, real *rcond, real *work, 
...
/*           Multiply by inv(U)*inv(L). */
	    ...
	    sgttrs_("No transpose", n, &c__1, &DL(1), &D(1), &DU(1), &DU2(1), 
		    &IPIV(1), &WORK(1), n, info);
	} else {

/*           Multiply by inv(L')*inv(U'). */

	    sgttrs_("Transpose", n, &c__1, &DL(1), &D(1), &DU(1), &DU2(1), &
		    IPIV(1), &WORK(1), n, info);
	}
	goto L20;
    }
