...
/* Subroutine */ int sspevd_(char *jobz, char *uplo, integer *n, real *ap, 
	real *w, real *z, integer *ldz, real *work, integer *lwork, integer *
...
/*  -- LAPACK driver routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int ssptrd_(char *, integer *, real *, real *, 
	    real *, real *, integer *), sopmtr_(char *, char *, char *
...
/*     For eigenvalues only, call SSTERF.  For eigenvectors, first call   
	...
	sstedc_("I", n, &W(1), &WORK(inde), &Z(1,1), ldz, &WORK(indwrk), 
		&llwork, &IWORK(1), liwork, info);
	sopmtr_("L", uplo, "N", n, n, &AP(1), &WORK(indtau), &Z(1,1), 
