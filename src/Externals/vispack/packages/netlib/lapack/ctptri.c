...
/*        Compute inverse of upper triangular matrix. */
	...
	for (j = 1; j <= *n; ++j) {
		...
		AP(jc+j-1).r = q__1.r, AP(jc+j-1).i = q__1.i;
		i__2 = jc + j - 1;
		q__1.r = -(doublereal)AP(jc+j-1).r, q__1.i = -(doublereal)AP(
			jc+j-1).i;
...
/*        Compute inverse of lower triangular matrix. */
	...
	for (j = *n; j >= 1; --j) {
		...
		AP(jc).r = q__1.r, AP(jc).i = q__1.i;
		i__1 = jc;
		q__1.r = -(doublereal)AP(jc).r, q__1.i = -(doublereal)AP(
			jc).i;
		ajj.r = q__1.r, ajj.i = q__1.i;
	    } else {
		q__1.r = -1.f, q__1.i = 0.f;
