...
/*  -- LAPACK driver routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *), zsytrf_(
	    char *, integer *, doublecomplex *, integer *, integer *, 
	    doublecomplex *, integer *, integer *), zsytrs_(char *, 
...
/*     Compute the factorization A = U*D*U' or A = L*D*L'. */
    ...
    zsytrf_(uplo, n, &A(1,1), lda, &IPIV(1), &WORK(1), lwork, info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	zsytrs_(uplo, n, nrhs, &A(1,1), lda, &IPIV(1), &B(1,1), ldb,
		 info);
