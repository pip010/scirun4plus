...
/* Subroutine */ int clarfx_(char *side, integer *m, integer *n, complex *v, 
	complex *tau, complex *c, integer *ldc, complex *work)
{
...
/*        Code for general M   
	...
	cgemv_("Conjugate transpose", m, n, &c_b2, &C(1,1), ldc, &V(1), &
		c__1, &c_b1, &WORK(1), &c__1);

/*        C := C - tau * v * w' */

	q__1.r = -(doublereal)tau->r, q__1.i = -(doublereal)tau->i;
	cgerc_(m, n, &q__1, &V(1), &c__1, &WORK(1), &c__1, &C(1,1), ldc);
	goto L410;
L10:
...
/*        Code for general N   
	...
	cgemv_("No transpose", m, n, &c_b2, &C(1,1), ldc, &V(1), &c__1, &
		c_b1, &WORK(1), &c__1);

/*        C := C - tau * w * v' */

	q__1.r = -(doublereal)tau->r, q__1.i = -(doublereal)tau->i;
	cgerc_(m, n, &q__1, &WORK(1), &c__1, &V(1), &c__1, &C(1,1), ldc);
	goto L410;
L210:
