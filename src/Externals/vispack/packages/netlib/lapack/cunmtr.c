...
/* Subroutine */ int cunmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, complex *a, integer *lda, complex *tau, complex *c, 
...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *), cunmql_(
	    char *, char *, integer *, integer *, integer *, complex *, 
	    integer *, complex *, complex *, integer *, complex *, integer *, 
	    integer *), cunmqr_(char *, char *, integer *, 
...
/*        Q was determined by a call to CHETRD with UPLO = 'U' */
	...
	i__1 = nq - 1;
	cunmql_(side, trans, &mi, &ni, &i__1, &A(1,2), lda, &
