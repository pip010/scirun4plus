...
/* Subroutine */ int cgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, complex *dl, complex *d, complex *du, complex *dlf, complex *df,
...
/*     Compute the norm of the matrix A. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = clangt_(norm, n, &DL(1), &D(1), &DU(1));
...
/*     Compute the solution vectors X. */
    ...
    cgttrs_(trans, n, nrhs, &DLF(1), &DF(1), &DUF(1), &DU2(1), &IPIV(1), &X(1,1), ldx, info);

/*     Use iterative refinement to improve the computed solutions and   
       compute error bounds and backward error estimates for them. */

    cgtrfs_(trans, n, nrhs, &DL(1), &D(1), &DU(1), &DLF(1), &DF(1), &DUF(1), &
