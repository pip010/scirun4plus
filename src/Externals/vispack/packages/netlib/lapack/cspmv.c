...
/*        Form  y  when AP contains the upper triangle. */
	...
	if (*incx == 1 && *incy == 1) {
		...
		for (i = 1; i <= j-1; ++i) {
		    ...
		    i__3 = k;
		    i__4 = i;
		    q__2.r = AP(k).r * X(i).r - AP(k).i * X(i).i, 
			    q__2.i = AP(k).r * X(i).i + AP(k).i * X(
			    i).r;
...
/* L50: */
		...
		i__3 = j;
		i__4 = kk + j - 1;
		q__3.r = temp1.r * AP(kk+j-1).r - temp1.i * AP(kk+j-1).i, q__3.i =
			 temp1.r * AP(kk+j-1).i + temp1.i * AP(kk+j-1).r;
...
/* L60: */
		...
		for (k = kk; k <= kk+j-2; ++k) {
		    ...
		    i__3 = k;
		    i__4 = ix;
		    q__2.r = AP(k).r * X(ix).r - AP(k).i * X(ix).i, 
			    q__2.i = AP(k).r * X(ix).i + AP(k).i * X(
			    ix).r;
		    q__1.r = temp2.r + q__2.r, q__1.i = temp2.i + q__2.i;
		    temp2.r = q__1.r, temp2.i = q__1.i;
		    ix += *incx;
...
/*        Form  y  when AP contains the lower triangle. */
	...
	if (*incx == 1 && *incy == 1) {
		...
		i__3 = j;
		i__4 = kk;
		q__2.r = temp1.r * AP(kk).r - temp1.i * AP(kk).i, q__2.i =
			 temp1.r * AP(kk).i + temp1.i * AP(kk).r;
