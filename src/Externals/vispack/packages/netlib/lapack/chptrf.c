...
/*        Determine rows and columns to be interchanged and whether   
	...
	i__1 = kc + k - 1;
	absakk = (r__1 = AP(kc+k-1).r, dabs(r__1));
...
*/
		    ...
		    i__1 = kpc + imax - 1;
		    if ((r__1 = AP(kpc+imax-1).r, dabs(r__1)) >= alpha * rowmax) {
...
leading   
		...
		for (j = kp + 1; j <= kk-1; ++j) {
		    ...
		    i__2 = knc + j - 1;
		    r_cnjg(&q__1, &AP(kx));
		    AP(knc+j-1).r = q__1.r, AP(knc+j-1).i = q__1.i;
		    i__2 = kx;
...
/* L30: */
		...
		AP(kx+kk-1).r = q__1.r, AP(kx+kk-1).i = q__1.i;
		i__1 = knc + kk - 1;
		r1 = AP(knc+kk-1).r;
		i__1 = knc + kk - 1;
		i__2 = kpc + kp - 1;
		d__1 = AP(kpc+kp-1).r;
		AP(knc+kk-1).r = d__1, AP(knc+kk-1).i = 0.f;
		i__1 = kpc + kp - 1;
		AP(kpc+kp-1).r = r1, AP(kpc+kp-1).i = 0.f;
		if (kstep == 2) {
		    i__1 = kc + k - 1;
		    i__2 = kc + k - 1;
		    d__1 = AP(kc+k-1).r;
...
e eigen-   
		...
		claev2_(&AP(kc - 1), &AP(kc + k - 2), &AP(kc + k - 1), &r1, &
			r2, &c, &s);
		r1 = 1.f / r1;
		r2 = 1.f / r2;
		i__1 = k - 2;
		crot_(&i__1, &AP(knc), &c__1, &AP(kc), &c__1, &c, &s);
		i__1 = k - 2;
		r__1 = -(doublereal)r1;
		chpr_(uplo, &i__1, &r__1, &AP(knc), &c__1, &AP(1));
		i__1 = k - 2;
		r__1 = -(doublereal)r2;
		chpr_(uplo, &i__1, &r__1, &AP(kc), &c__1, &AP(1));
...
/*              Store U(k) and U(k-1) in columns k and k-1 */
		...
		i__1 = k - 2;
		csscal_(&i__1, &r1, &AP(knc), &c__1);
		i__1 = k - 2;
		csscal_(&i__1, &r2, &AP(kc), &c__1);
		i__1 = k - 2;
		q__1.r = -(doublereal)s.r, q__1.i = -(doublereal)s.i;
		crot_(&i__1, &AP(knc), &c__1, &AP(kc), &c__1, &c, &q__1);
	    }
	}
...
*/
		    ...
		    i__1 = kpc;
		    if ((r__1 = AP(kpc).r, dabs(r__1)) >= alpha * rowmax) {
...
trailing   
		...
		for (j = kk + 1; j <= kp-1; ++j) {
		    ...
		    i__2 = knc + j - kk;
		    r_cnjg(&q__1, &AP(kx));
		    AP(knc+j-kk).r = q__1.r, AP(knc+j-kk).i = q__1.i;
		    i__2 = kx;
		    AP(kx).r = t.r, AP(kx).i = t.i;
/* L60: */
		}
		...
		AP(knc+kp-kk).r = q__1.r, AP(knc+kp-kk).i = q__1.i;
		i__1 = knc;
		r1 = AP(knc).r;
		i__1 = knc;
		i__2 = kpc;
		d__1 = AP(kpc).r;
		AP(knc).r = d__1, AP(knc).i = 0.f;
		i__1 = kpc;
		AP(kpc).r = r1, AP(kpc).i = 0.f;
		if (kstep == 2) {
		    i__1 = kc;
		    i__2 = kc;
		    d__1 = AP(kc).r;
...
sing the eigen-   
		    ...
		    r_cnjg(&q__1, &AP(kc + 1));
		    claev2_(&AP(kc), &q__1, &AP(knc), &r1, &r2, &c, &s);
		    r1 = 1.f / r1;
		    r2 = 1.f / r2;
		    i__1 = *n - k - 1;
		    crot_(&i__1, &AP(kc + 2), &c__1, &AP(knc + 1), &c__1, &c, 
			    &s);
		    i__1 = *n - k - 1;
		    r__1 = -(doublereal)r1;
		    chpr_(uplo, &i__1, &r__1, &AP(kc + 2), &c__1, &AP(knc + *
			    n - k));
		    i__1 = *n - k - 1;
		    r__1 = -(doublereal)r2;
		    chpr_(uplo, &i__1, &r__1, &AP(knc + 1), &c__1, &AP(knc + *
			    n - k));
...
k+1 */
		    ...
		    i__1 = *n - k - 1;
		    csscal_(&i__1, &r1, &AP(kc + 2), &c__1);
		    i__1 = *n - k - 1;
		    csscal_(&i__1, &r2, &AP(knc + 1), &c__1);
		    i__1 = *n - k - 1;
		    q__1.r = -(doublereal)s.r, q__1.i = -(doublereal)s.i;
		    crot_(&i__1, &AP(kc + 2), &c__1, &AP(knc + 1), &c__1, &c, 
			    &q__1);
