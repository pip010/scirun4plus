...
on   
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgeru_(&i__1, nrhs, &z__1, &A(1,k), &c__1, &B(k,1), ldb, &B(1,1), ldb);

/*           Multiply by the inverse of the diagonal block. */

	    z_div(&z__1, &c_b1, &A(k,k));
	    zscal_(nrhs, &z__1, &B(k,1), ldb);
	    --k;
	} else {
...
on   
	    ...
	    i__1 = k - 2;
	    z__1.r = -1., z__1.i = 0.;
	    zgeru_(&i__1, nrhs, &z__1, &A(1,k-1), &c__1, &B(k-1,1), ldb, &B(1,1), ldb);

/*           Multiply by the inverse of the diagonal block. */

	    i__1 = k - 1 + k * a_dim1;
	    akm1k.r = A(k-1,k).r, akm1k.i = A(k-1,k).i;
	    z_div(&z__1, &A(k-1,k-1), &akm1k);
	    akm1.r = z__1.r, akm1.i = z__1.i;
	    z_div(&z__1, &A(k,k), &akm1k);
...
ion   
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgemv_("Transpose", &i__1, nrhs, &z__1, &B(1,1), ldb, &A(1,k), &c__1, &c_b1, &B(k,1), ldb);
...
rmation   
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgemv_("Transpose", &i__1, nrhs, &z__1, &B(1,1), ldb, &A(1,k+1), &c__1, &c_b1, &B(k+1,1), ldb);
...
on   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &A(k+1,k), &c__1, &B(k,1), ldb, &B(k+1,1), ldb);
	    }
...
on   
		...
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &A(k+2,k), &c__1, &B(k,1), ldb, &B(k+2,1), ldb);
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = 0.;
		zgeru_(&i__1, nrhs, &z__1, &A(k+2,k+1), &
...
ion   
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Transpose", &i__1, nrhs, &z__1, &B(k+1,1), 
			ldb, &A(k+1,k), &c__1, &c_b1, &B(k,1), ldb);
	    }
...
rmation   
		...
		z__1.r = -1., z__1.i = 0.;
		zgemv_("Transpose", &i__1, nrhs, &z__1, &B(k+1,1), 
			ldb, &A(k+1,k-1), &c__1, &c_b1, &B(k-1,1), ldb);
	    }
