...
/*  -- LAPACK driver routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *), zhetrf_(
	    char *, integer *, doublecomplex *, integer *, integer *, 
	    doublecomplex *, integer *, integer *), zhetrs_(char *, 
...
/*     Compute the factorization A = U*D*U' or A = L*D*L'. */
    ...
    zhetrf_(uplo, n, &A(1,1), lda, &IPIV(1), &WORK(1), lwork, info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	zhetrs_(uplo, n, nrhs, &A(1,1), lda, &IPIV(1), &B(1,1), ldb,
		 info);
