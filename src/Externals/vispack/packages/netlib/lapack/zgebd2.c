...
/* Subroutine */ int zgebd2_(integer *m, integer *n, doublecomplex *a, 
	integer *lda, doublereal *d, doublereal *e, doublecomplex *tauq, 
...
/*           Apply H(i)' to A(i:m,i+1:n) from the left */
	    ...
	    i__3 = *n - i;
	    d_cnjg(&z__1, &TAUQ(i));
	    zlarf_("Left", &i__2, &i__3, &A(i,i), &c__1, &z__1, &A(i,i+1), lda, &WORK(1));
	    i__2 = i + i * a_dim1;
	    i__3 = i;
	    A(i,i).r = D(i), A(i,i).i = 0.;
...
/*              Apply G(i) to A(i+1:m,i+1:n) from the right */
		...
		i__2 = *m - i;
		i__3 = *n - i;
		zlarf_("Right", &i__2, &i__3, &A(i,i+1), lda, &
...
/* Computing MIN */
	    i__4 = i + 1;
	    zlarf_("Right", &i__2, &i__3, &A(i,i), lda, &TAUP(i), &
...
/*              Apply H(i)' to A(i+1:m,i+1:n) from the left */
		...
		i__3 = *n - i;
		d_cnjg(&z__1, &TAUQ(i));
		zlarf_("Left", &i__2, &i__3, &A(i+1,i), &c__1, &
			z__1, &A(i+1,i+1), lda, &WORK(1))
			;
		i__2 = i + 1 + i * a_dim1;
		i__3 = i;
