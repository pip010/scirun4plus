...
/*           Compute column K of the inverse. */
		...
		d__1 = z__2.r;
		z__1.r = AP(kc+k-1).r - d__1, z__1.i = AP(kc+k-1).i;
...
/*           2 x 2 diagonal block   
	    ...
	    i__1 = kcnext + k - 1;
	    z__1.r = AP(kcnext+k-1).r / t, z__1.i = AP(kcnext+k-1).i / t;
	    ...
	    i__1 = kcnext + k;
	    d__1 = ak / d;
	    AP(kcnext+k).r = d__1, AP(kcnext+k).i = 0.;
	    i__1 = kcnext + k - 1;
...
/*           Compute columns K and K+1 of the inverse. */
		...
		d__1 = z__2.r;
		z__1.r = AP(kcnext+k).r - d__1, z__1.i = AP(kcnext+k).i;
...
/*           Interchange rows and columns K and KP in the leading 
		...
		i__2 = kc + j - 1;
		d_cnjg(&z__1, &AP(kx));
		AP(kc+j-1).r = z__1.r, AP(kc+j-1).i = z__1.i;
		i__2 = kx;
...
/* L40: */
	    ...
	    AP(kc+kp-1).r = z__1.r, AP(kc+kp-1).i = z__1.i;
	    i__1 = kc + k - 1;
...
/*           Compute column K of the inverse. */
		...
		d__1 = z__2.r;
		z__1.r = AP(kc).r - d__1, z__1.i = AP(kc).i;
...
/*           2 x 2 diagonal block   
	    ...
	    akp1 = AP(kc).r / t;
	    i__1 = kcnext + 1;
	    z__1.r = AP(kcnext+1).r / t, z__1.i = AP(kcnext+1).i / t;
	    akkp1.r = z__1.r, akkp1.i = z__1.i;
	    d = t * (ak * akp1 - 1.);
	    i__1 = kcnext;
	    d__1 = akp1 / d;
	    AP(kcnext).r = d__1, AP(kcnext).i = 0.;
	    i__1 = kc;
	    d__1 = ak / d;
	    AP(kc).r = d__1, AP(kc).i = 0.;
	    i__1 = kcnext + 1;
...
/*           Compute columns K-1 and K of the inverse. */
		...
		d__1 = z__2.r;
		z__1.r = AP(kcnext).r - d__1, z__1.i = AP(kcnext).i;
...
/*           Interchange rows and columns K and KP in the trailing
		...
		i__2 = kc + j - k;
		d_cnjg(&z__1, &AP(kx));
		AP(kc+j-k).r = z__1.r, AP(kc+j-k).i = z__1.i;
		i__2 = kx;
		AP(kx).r = temp.r, AP(kx).i = temp.i;
/* L70: */
	    }
	    ...
	    AP(kc+kp-k).r = z__1.r, AP(kc+kp-k).i = z__1.i;
	    i__1 = kc;
