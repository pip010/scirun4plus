...
/*  -- LAPACK routine (version 2.0) --   
   ...
   Parameter adjustments   
    ...
    /* Local variables */
    static integer lopt;
    extern /* Subroutine */ int xerbla_(char *, integer *), sgeqrf_(
	    integer *, integer *, real *, integer *, real *, real *, integer *
	    , integer *), sgerqf_(integer *, integer *, real *, integer *, 
...
/*     QR factorization of N-by-M matrix A: A = Q*R */
    ...
    sgeqrf_(n, m, &A(1,1), lda, &TAUA(1), &WORK(1), lwork, info);
    lopt = WORK(1);

/*     Update B := Q'*B. */

    i__1 = min(*n,*m);
    sormqr_("Left", "Transpose", n, p, &i__1, &A(1,1), lda, &TAUA(1), &B(1,1), ldb, &WORK(1), lwork, info);
/* Computing MAX */
...
/*     RQ factorization of N-by-P matrix B: B = T*Z. */
    ...
    sgerqf_(n, p, &B(1,1), ldb, &TAUB(1), &WORK(1), lwork, info);
/* Computing MAX */
    i__1 = lopt, i__2 = (integer) WORK(1);
