...
/*     Quick return if possible */
	...
	if (wantsp) {
	    *sep = clange_("1", n, n, &T(1,1), ldt, rwork);
	}
	goto L40;
    }
...
/*           Swap the K-th eigenvalue to position KS. */
	    ...
	    if (k != ks) {
		ctrexc_(compq, n, &T(1,1), ldt, &Q(1,1), ldq, &k, &
			ks, &ierr);
	    }
	}
/* L20: */
...
/*        Solve the Sylvester equation for R:   
	...
	clacpy_("F", &n1, &n2, &T(1,n1+1), ldt, &WORK(1), &n1);
	ctrsyl_("N", "N", &c_n1, &n1, &n2, &T(1,1), ldt, &T(n1+1,n1+1), ldt, &WORK(1), &n1, &scale, &ierr);
...
/*              Solve T11*R - R*T22 = scale*X. */
		...
		ctrsyl_("N", "N", &c_n1, &n1, &n2, &T(1,1), ldt, &T(n1+1,n1+1), ldt, &WORK(1), &n1, &scale, &
			ierr);
	    } else {

/*              Solve T11'*R - R*T22' = scale*X. */

		ctrsyl_("C", "C", &c_n1, &n1, &n2, &T(1,1), ldt, &T(n1+1,n1+1), ldt, &WORK(1), &n1, &scale, &
			ierr);
	    }
	    goto L30;
	}
