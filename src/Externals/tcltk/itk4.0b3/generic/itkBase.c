...
namespace eval ::itk {\n\
    proc _find_init {} {\n\
        ...
        if {[info exists library]} {\n\
            ...
            lappend dirs [file join $tcl_library itk$patchLevel]\n\
            set bindir [file dirname [info nameofexecutable]]\n\
            lappend dirs [file join $bindir .. lib itk$patchLevel]\n\
            lappend dirs [file join $bindir .. lib Debug itk$patchLevel]\n\
            lappend dirs [file join $bindir .. lib Release itk$patchLevel]\n\
            lappend dirs [file join $bindir .. library]\n\
            lappend dirs [file join $bindir .. .. library]\n\
            lappend dirs [file join $bindir .. .. itk library]\n\
            # Check the directories in the tcl_pkgPath\n\
