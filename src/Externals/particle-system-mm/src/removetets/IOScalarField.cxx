...
//  if ( !in )
//  { 
//    cout << "Error opening indicator filename file " << filename << endl;
//    exit ( 1 );
//  }
//
...
//      case INTERPOLATING:
//      _indicators[i] =
//        new ScalarField( buffer, 0.0, ScalarField::CATMULLROM,
//                         scale_x, scale_y, scale_z );
//      break;
//
//      case APPROXIMATING:
//      _indicators[i] =
//        new ScalarField( buffer, 0.0, ScalarField::BSPLINE,
//                         scale_x, scale_y, scale_z );
//      break;
//
//      default:
//      cout << "No such kernel type" << endl;
//
//      exit( 1 );
//      break;
//    }
