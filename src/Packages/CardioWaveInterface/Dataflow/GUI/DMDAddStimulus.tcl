itcl::class CardioWaveInterface_DiscreteMultiDomain_DMDAddStimulus {
    inherit Module
     constructor { {args ""} } {
        eval configure $args
    ...
    method ui {} {
      ...
      grid $stim.en2 -row 2 -column 1 -columnspan 2 -sticky w
      grid $stim.en3 -row 3 -column 1 -columnspan 2 -sticky w
      grid $stim.en4 -row 4 -column 1 -columnspan 2 -sticky w
      grid $stim.cb1 -row 5 -column 0 -columnspan 3 -sticky w    
      grid $stim.cb2 -row 6 -column 0 -columnspan 3 -sticky w
